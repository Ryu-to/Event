...
$sql = 'INSERT INTO event_table(id,event,description,category,event_area,address,person,hour,price,reserve_limit,mini_person) VALUES (null,:event,:description,:category,:event_area,:address,:person,:hour,:price,:reserve_limit,:mini_person)';
